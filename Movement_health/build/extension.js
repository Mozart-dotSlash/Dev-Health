...
let globalStorage = {}
console.log("The Extension 'movementreminder' has started");
let helloWorld = vscode.commands.registerCommand('movementreminder.helloWorld',async function () {
...
let MovementReminder = vscode.commands.registerCommand('movementreminder.MovementReminder',async function () {
let funcName = "Movement_Reminder"; let pyVar = "python";
        let py = spawn(pyVar, [pythonPath, funcName]);
...
context.subscriptions.push(MovementReminder);
}
