...
let helloWorld = vscode.commands.registerCommand('testpy.helloWorld',async function () {
...
let MovementReminder = vscode.commands.registerCommand('testpy.MovementReminder',async function () {
