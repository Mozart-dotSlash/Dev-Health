...
def call(t):
    time.sleep(t)
    vscode.window.show_open_dialog("Fuck")
    vscode.window.show_error_message("Fuck touy btcha")
    vscode.window.show_warn_message("You've been sitting for "+ str(t)+"seconds straight, stay healthy while proogramming by taking a 1 minute walk/exercise")
    call(t)
