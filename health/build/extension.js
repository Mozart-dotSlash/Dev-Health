...
let globalStorage = {}
console.log("The Extension 'eye-care' has started");
let StartEyeCare = vscode.commands.registerCommand('eye-care.StartEyeCare',async function () {
let funcName = "Start_Eye_Care"; let pyVar = "python";
...
context.subscriptions.push(StartEyeCare);
}
